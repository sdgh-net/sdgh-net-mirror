...
function smartLogin(){
  ...
  return true;
    ...
    // Begin cs_help.cgi
      function openHelp(sHelp)
      {
		...
		helpWin.document.write('<HTML><HEAD><TITLE>在线帮助</TITLE></HEAD><FRAMESET BORDER=0 ROWS="24, *">');
  ...
  var asearch  = "搜索所有邮件";
  var logout   = "登出";
  var check	= "按此开始检查所有地方";
  var CSSstatus = "0";
  var CSSObject = '菜单选项';
  var CSSselect = "请选择收件者";
  var Preferences = "邮箱设置";
  var subfold = "邮箱管理";
  var ab = "地址簿";
  var calendar = "日程表";
  var mailboxname = "邮件箱";
  var passwordpassword = "修改密码";
  var planplanplanplan = "修改数字签名";
  var signaturesignature = "修改我的签名";
  var userprefuserpref = "用户个性化设置";
  var chgvacchgvacchgvac = "外出自动回复";
  var chgfwdchgfwdchgfwd = "修改邮件转发";
  var chgldapchgldapchgldap = "改变用户信息";
  var autoresplinkautoresplink = "编辑自动回复";
  var chgruleschgrules = "修改处理规则";
...
border=0>
                            <TBODY>
                              ...
                              <TR>
                                <TD align=right width="29%" height=30  style="font-size:9pt ">邮箱帐号</TD>
                                <TD height=30>
                              ...
                              <TR>
                                <TD align=right width="29%"  style="font-size:9pt ">登录密码</TD>
                                <TD>
                                    <INPUT 
...
&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                  ...
                  face="Arial, Helvetica, sans-serif">安全浏览(页面自动过期)<B><br>
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="26" valign="bottom"><span class="style2"> 账号要求输入全称，如：<b>name@xxxxx.com</b></span></td>
                  </tr>
                  <tr>
                    <td><table width="100%" height="44"  border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td height="34"   style="font-size:9pt "><font color="#666666">当前时间:
